...
total_h= 20;    // height of the hook, top to bottom
hook_d= 20;     // diameter of the hook
width= 4;     // width of the hook
...
module octagon_profile() octagon(od=$hole_d * $peg_hole_percentage, realign=true, rounding=1, $fn=32);
